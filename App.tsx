              ...
              {CRITERIA.map(criterion => {
                ...
                return (
                  <button
                    ...
                    className={`
                      relative p-5 rounded-xl border text-left transition-all duration-200 flex items-center justify-between group
                      ${isSelected 
                  ...
                  >
                    ...
                    <div className={`
                      ...
                      ${isSelected ? 'bg-brand-500 border-brand-500' : 'border-slate-300 bg-white group-hover:border-brand-400'}
                    `}>
                      {isSelected && <Icon name="check" className="text-white" size={14} />}
                    </div>
                  </button>
                )
              })}
